...
# i = arr_overlap.to_delayed().ravel()[0].compute()
# # j = GpuArrFuncs.tophat_filt(i, 5)
# # print(j)
# # j = GpuArrFuncs.dog_filt(i, 5, 10)
# # print(j)
# # j = GpuArrFuncs.gauss_subt_filt(i, 10)
# # print(j)
# # j = GpuArrFuncs.otsu_thresh(i)
# # print(j)
# # j = GpuArrFuncs.mean_thresh(i, 10)
# # print(j)
# # j = GpuArrFuncs.manual_thresh(i, 10)
# # print(j)
# # j = GpuArrFuncs.label_objects_with_ids(i)
# # print(j)
# # j = GpuArrFuncs.label_objects_with_sizes(i)
# # print(j)
# # j = GpuArrFuncs.filter_by_size(i, 10, 20)
# # print(j)
# # j = GpuArrFuncs.get_local_maxima(i, 10)
# # print(j)
# # j = GpuArrFuncs.mask(i, j)
# # print(j)
# j = GpuArrFuncs.region_to_coords(i)
# print(j)
# j = GpuArrFuncs.maxima_to_coords(i)
# print(j)
