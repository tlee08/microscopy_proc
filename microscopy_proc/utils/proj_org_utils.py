...
def get_proj_fp_dict(proj_dir):
    return {
        ...
        "smoothed": os.path.join(proj_dir, "registration", "3a_smoothed.tif"),
        "mask": os.path.join(proj_dir, "registration", "3b_masked.tif"),
        "mask_l": os.path.join(proj_dir, "registration", "3c_mask_l.tif"),
        "mask_r": os.path.join(proj_dir, "registration", "3c_mask_r.tif"),
        "outline_df": os.path.join(proj_dir, "registration", "3d_outline.parquet"),
        "outline": os.path.join(proj_dir, "registration", "3d_outline.tif"),
        "outline_reg": os.path.join(proj_dir, "registration", "3e_outline_reg.tif"),
        "mask_reg": os.path.join(proj_dir, "registration", "3f_mask_reg.tif"),
