...
class ProjFpModelBase(FpModel):
    ...
    def __init__(
        ...
        self.cellcount_final_sdir = ObservedAttr(
            cellcount_final_sdir, set_callable=self.set_filepaths
        )
        ...
        self.visual_comb_sdir = ObservedAttr(
            visual_comb_sdir, set_callable=self.set_filepaths
        )
        # Setting filepath attributes
        self.subdirs_ls = []
        self.set_filepaths()
    ...
    def set_filepaths(self):
        ...
        self.threshd_final = FpAttr(
            [self.root_dir.val, self.cellcount_final_sdir.val, "threshd.zarr"]
        )
        self.maxima_final = FpAttr(
            [self.root_dir.val, self.cellcount_final_sdir.val, "maxima.zarr"]
        )
        self.wshed_final = FpAttr(
            [self.root_dir.val, self.cellcount_final_sdir.val, "wshed.zarr"]
        )
        ...
        self.comb_reg = FpAttr(
            [self.root_dir.val, self.visual_comb_sdir.val, "comb_reg.tif"]
        )
        self.comb_cellc = FpAttr(
            [self.root_dir.val, self.visual_comb_sdir.val, "comb_cellc.tif"]
        )
        self.comb_points = FpAttr(
            [self.root_dir.val, self.visual_comb_sdir.val, "comb_points.tif"]
        )
