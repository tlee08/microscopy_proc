...
class ProjFpModelBase:
    ...
    _ref: tuple[str | None, str] = ("REFERENCE", "0a_reference.tif")
    _annot: tuple[str | None, str] = ("REFERENCE", "0b_annotation.tif")
    _map: tuple[str | None, str] = ("REFERENCE", "0c_mapping.json")
    _affine: tuple[str | None, str] = ("REFERENCE", "0d_align_affine.txt")
    _bspline: tuple[str | None, str] = ("REFERENCE", "0e_align_bspline.txt")
    _downsmpl1: tuple[str | None, str] = ("REFERENCE", "1_downsmpl1.tif")
    _downsmpl2: tuple[str | None, str] = ("REFERENCE", "2_downsmpl2.tif")
    _trimmed: tuple[str | None, str] = ("REFERENCE", "3_trimmed.tif")
    _regresult: tuple[str | None, str] = ("REFERENCE", "4_regresult.tif")
